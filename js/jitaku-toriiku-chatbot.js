...
(function () {
  ...
  var LINKS = {
    ...
    ios: "https://apps.apple.com/jp/app/apple-store/id6785268481?pt=129075299&ct=202609_21&mt=8",
    android:
      "https://play.google.com/store/apps/details?id=com.toriiku.app&utm_source=ctd&utm_medium=flyer&utm_campaign=202609_21",
    terms: "https://toriiku-jp.com/terms.html#home"
  };
  ...
  var FAQ_DATA = [
    ...
    },
    {
      ...
      answer:
        "本サービスは、国土交通省採択事業「物流負荷低減に向けた多様・柔軟な受取り方法普及促進事業」の一環として実施している取り組みです。事業の詳細は特設サイトをご覧ください。" +
        L_MLIT,
      keywords: ["国土交通省", "国交省", "補助事業", "実証", "国の事業", "公的", "採択"]
    },
    {
      category: "サービス概要",
      question: "なぜポイントがもらえるのですか？",
      answer:
        "国土交通省採択事業「物流負荷低減に向けた多様・柔軟な受取り方法普及促進事業」の一環として、物流の負荷低減にご協力いただいたお礼にポイントを還元しています。" +
        L_MLIT,
      keywords: ["なぜポイント", "なぜ", "どうして", "理由", "仕組み", "からくり", "怪しく", "怪しい", "無料なのに"]
    },
    ...
    {
      category: "使い方",
      question: "対象にならない荷物はありますか？",
      answer: "伝票がお手元に残らないもの（メール便・ポスト投函など）は対象外となります。",
      keywords: [
        "対象外",
        "対象にならない",
        "だめな荷物",
    ...
    },
    {
      ...
      answer:
        "画像が不鮮明・情報が不足している場合は、LINEで再提出のご案内をお送りします。あらためてご提出いただければ、ポイント付与の対象となります。明るい場所で、送り状全体が正面から写るように撮り直してください。",
      keywords: [
        "承認されない",
        "却下",
        "読み取れ",
    ...
    },
    {
      ...
      answer:
        "トリイクポイントは、外部サービス「デジコ（株式会社DIGITALIO提供）」を通じて、お好きなポイント・ギフトに交換できます。1ポイント＝1円相当です。交換先のラインナップは予告なく変更となる場合があります。" +
        L_POINT,
      keywords: [
        "交換",
        "何に交換",
